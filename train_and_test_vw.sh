...
#echo "Training"
options="-b 29 --quiet --search 3 --affix -3w,3w --ignore Q --search_task sequence --search_neighbor_features -1:w,1:w,-1:pos,-1:N,1:N,-2:w,2:w --search_history_length 2 --passes 10 --learning_rate 0.07492 -c -k --holdout_off"
model_name="vw_model.model"

train_command="vw ${options}  tmp_train.txt -f ${MODEL_PATH}${model_name}"
#echo $train_command
test_command="vw --quiet -t -i ${MODEL_PATH}${model_name} temp_test.txt -p ${prediction}"
